...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<c:forEach items="${pagination.list }" var="brand">
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center"><img width="40" height="40" src="${pageContext.request.contextPath }/images/pic/ppp.jpg"/></td>
			<td align="center"></td>
			...
			<td align="center">
			<a class="pn-opt" href="${pageContext.request.contextPath }/brand/toEdit.do?brandId=${brand.brandId }">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}" href="#">删除</a>
			</td>
		</tr>
	</c:forEach>
