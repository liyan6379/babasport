			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<img width="100" height="100" id="allUrl" src="${brand.brandImgUrl}"/>
						<input type="hidden" name="brandImgUrl" value="${brand.brandImgUrl}" id="imgUrl"/>
						<input type="file" name="brandImgUrl" onchange="uploadPic()"/>
					</td>
				</tr>
				...
				<tr>
					...
					<input type="radio" name="isDisplay" value="1" <c:if test="${brand.isDisplay==1}">checked="checked"</c:if> checked="checked"/>可用
